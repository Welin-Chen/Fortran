...
subroutine sub_atmosphere()
  ...
  use solution
  implicit none
  integer, parameter :: unit_atmosphere=10,unit_atmosphere_check=15,unit_atmosphere_debug=20
...
subroutine sub_parameter(thrust,physical)
  ...
  use solution
  implicit none
  integer, parameter :: unit_out_physical_debug=10
  real*8  thrust(5)
  real*8  physical(4)
  real*8  A,A1,A2
  real*8  B,B1,B2
...
subroutine sub_F_thrust(F_thrust,thrust)
  ...
  use constant
  implicit none
  integer,parameter :: unit_output_thrust_debug=11
